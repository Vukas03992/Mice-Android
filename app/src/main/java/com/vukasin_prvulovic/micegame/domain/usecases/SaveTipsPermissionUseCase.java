...
@PerFragment
public class SaveTipsPermissionUseCase extends UseCase<Boolean>{

    private TipsRepository repository;

    @Inject
    public SaveTipsPermissionUseCase(ThreadExecutor executor, PostExecutionThread postExecutionThread, TipsRepository repository) {
    ...
    protected Observable<Boolean> buildUseCaseObservable(Object... params) {
        return repository.saveTipsPermission((boolean)params[0]);
    }
}
