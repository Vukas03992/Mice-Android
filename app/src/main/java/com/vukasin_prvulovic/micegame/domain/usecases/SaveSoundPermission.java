...
@PerFragment
public class SaveSoundPermission extends UseCase<Boolean>{

    private MusicRepository repository;

    @Inject
    public SaveSoundPermission(ThreadExecutor executor, PostExecutionThread postExecutionThread, MusicRepository repository) {
    ...
    protected Observable<Boolean> buildUseCaseObservable(Object... params) {
        return repository.saveSoundPermission((boolean)params[0]);
    }
}
